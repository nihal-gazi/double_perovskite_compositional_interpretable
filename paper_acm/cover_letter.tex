...
\textbf{Subject: Submission of Original Research Article to \textit{Journal of Chemical Information and Modeling}}

\bigskip

Dear Prof. Merz and Editorial Board Members,

We are pleased to submit our original research manuscript entitled \textbf{``Physics-Gated Interpretable Machine Learning and Symbolic Regression for Double Perovskites: Overcoming Theoretical Limits Beyond 0D Compositional Models''} for consideration as a full Research Article in the \textit{Journal of Chemical Information and Modeling} (JCIM).
...
\begin{itemize}
    ...
    \item All authors have approved the manuscript and agree to its submission to JCIM.
...
\begin{enumerate}
    \item \textbf{Prof. Runhai Ouyang} (Shanghai University / FHI Berlin), \textit{Email:} \url{rouyang@shu.edu.cn} -- Expert in symbolic regression and SISSO materials informatics.
    \item \textbf{Prof. Shyue Ping Ong} (UC San Diego), \textit{Email:} \url{ongsp@ucsd.edu} -- Expert in materials machine learning and perovskite stability.
    \item \textbf{Prof. Chris Wolverton} (Northwestern University), \textit{Email:} \url{c-wolverton@northwestern.edu} -- Expert in DFT databases and perovskite thermodynamics.
    \item \textbf{Prof. Aron Walsh} (Imperial College London), \textit{Email:} \url{a.walsh@imperial.ac.uk} -- Expert in perovskite electronic structure and tight-binding theory.
\end{enumerate}
