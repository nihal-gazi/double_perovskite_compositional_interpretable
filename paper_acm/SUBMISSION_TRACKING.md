...
- **Corresponding Authors**: 
  ...
  - Soumyadipta Pal (`soumyadipta.pal@gmail.com`)
...
2. **Resubmission (Completed & Accepted by Technical Office on Aug 31, 2026)**:
   ...
   - Uploaded Artifacts:
     ...
     - `Supporting Information for Publication*`: `supporting_information.pdf` (9 pages, S1–S9, Tables S1–S5, Figures S1–S4)
     - `Graphic for manuscript (TOC Graphic)`: `toc_graphic.pdf` / `toc_graphic.png`
   - Reviewers Nominated:
     1. Prof. Aron Walsh (`a.walsh@imperial.ac.uk`, Imperial College London)
