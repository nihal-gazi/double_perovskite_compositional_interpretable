"""
src/master_features.py
======================
Engine for master multi-operator physical feature expansion.
...
def generate_master_features(df: pd.DataFrame, base_feature_cols: list) -> tuple[np.ndarray, list]:
    """
    Generates a multi-operator physical feature matrix:
    - Base features (33)
