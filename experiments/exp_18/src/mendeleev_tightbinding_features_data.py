"""
src/mendeleev_tightbinding_features_data.py
============================================
Data lookup dictionaries for Pettifor Mendeleev numbers, First Ionization Energies (eV), and Electron Affinities (eV).
"""
