# Experiment 20: Single-Perovskite Convex Hull Tie-Line Engine Report
...
**New Physical Descriptors Added:** Single-Perovskite Competing Phase Tie-Line Engine (`D_hull_proxy`, `Delta_t_sub_perov`, `Delta_H_sub_perov_mismatch`), Exponential Distance Scaling (`Exp_D_hull_scale`).  
