"""
src/exponential_hull_model.py
=============================
Engine for Experiment 20:
Refined Hard-Margin Boundary Classifier (C=200.0) + Exponential Tie-Line Stage 2 Regressor.
"""
...
class ExponentialHullModel:
    """
    Exponential Convex Hull Model Manager for Exp 20.
    """
    ...
    def __init__(self, target_name: str):
        ...
        if "Formation Energy" in target_name:
            ...
            self.reg_model = Ridge(alpha=1.0, random_state=42)
            # High-C (C=200.0) Refined Hard-Margin Classifier
