...
with custom +1/-1 classification fitness scoring metric and protected 'pow' operator.
"""
...
class SymbolicBoundaryClassifier:
    ...
    ----------
    population_size : int
        Number of GP candidate programs per generation (default: 1500).
    generations : int
        Number of evolution generations (default: 15).
    random_state : int
