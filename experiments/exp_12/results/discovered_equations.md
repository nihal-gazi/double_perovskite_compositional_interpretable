# Experiment 12: Discovered Physical Interaction Equations Report

This document contains the top 15 most influential interaction terms ($x_i x_j$, $x_i/x_j$, $x_i^2$) and their fitted coefficients across all 4 target properties.
...
- **Two-Stage Hurdle Pipeline $R^2$:** **7.68%**  
- **Relative Theoretical Limit Achieved:** **15.37%**  
...
- **Two-Stage Hurdle Pipeline $R^2$:** **20.53%**  
- **Relative Theoretical Limit Achieved:** **34.22%**  
...
- **Two-Stage Hurdle Pipeline $R^2$:** **10.83%**  
- **Relative Theoretical Limit Achieved:** **43.30%**  
