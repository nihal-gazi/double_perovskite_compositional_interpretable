...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Band Gap (eV)** | `borlido_2019_sisso` | 2000 | -6.34 $\pm$ 0.48% | **0.00%** | -6.86 $\pm$ 3.54% | **0.00%** | 62.07 $\pm$ 2.33% | 1.620071 | 1.0403 |
...
3. **In-Distribution vs. OOD Generalization**:
   - In-Distribution fit yields an $R^2$ of **-6.77%** (0.00% of limit).
   - 80/20 Out-of-Distribution evaluation yields a test $R^2$ of **-6.86 $\pm$ 3.54%** (0.00% of limit).
