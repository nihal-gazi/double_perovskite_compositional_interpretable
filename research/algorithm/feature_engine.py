...
feature_engine.py
=================
Master 100% Pure Compositional & 0D Quantum Feature Engineering Engine.
STRICT AUDIT GUARANTEE: Uses ZERO 3D atomic coordinates or GNN surrogates.
"""
...
def generate_algorithm_features(df: pd.DataFrame, base_feature_cols: list) -> tuple[np.ndarray, list]:
    """
    Constructs the master feature matrix:
    1. Single-Perovskite Competing Phase Tie-Line Engine
    2. Octahedral d0/d10 Closed-Shell Crystal Field Engine
    3. Binary Oxide Formation Enthalpy Mismatch Engine
    4. Harrison Tight-Binding Quantum Gap & Birch-Murnaghan Strain Engine
    5. Mendeleev Number, IE, EA, VEC & Multi-Operator Term Expansions
    """
