...
data_lookup.py
==============
Authoritative elemental physical and thermodynamic lookup tables.
Used exclusively for 100% pure 0D compositional feature generation.
"""
...
EA_OXYGEN = 1.461          # Electron affinity of Oxygen (eV)
R_OXYGEN_SHANNON = 1.40   # Shannon ionic radius of O2- (Angstroms)
